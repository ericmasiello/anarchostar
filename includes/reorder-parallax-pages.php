...
function themespectrum_enable_block_sort() {
		...
		add_submenu_page('edit.php?post_type=page', 'Sort Home Page Blocks', 'Sort', 'edit_posts', basename(__FILE__), 'themespectrum_sort_blocks');
...
function themespectrum_sort_blocks() {
	$blocks = new WP_Query('post_type=page&posts_per_page=-1&orderby=menu_order&order=ASC');
