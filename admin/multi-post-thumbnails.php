...
if (!class_exists('MultiPostThumbnails')) {
	...
	class MultiPostThumbnails {
		...
		public function enqueue_admin_scripts() {
			$template_url = get_bloginfo('template_url') . '/scripts/multi-post-thumbnails-admin.js';
		...
		private function post_thumbnail_html($thumbnail_id = null) {
			...
			$content .= '<p><em>This will place a floating image over your custom background. For best results use a png when using transparent backgrounds. <br /><br />This will be 500px wide on the desktop view and a featured/background image must be set for this feature to work.</em></p>';
			...
			if ($thumbnail_id && get_post($thumbnail_id)) {
				...
				if (!empty($thumbnail_html)) {
					...
					$content .= '<p><em>This will place a floating image over your custom background. For best results use a png when using transparent backgrounds. <br /><br /><strong>A featured/background image must be set for this feature to work.</strong></em></p>';
				}
