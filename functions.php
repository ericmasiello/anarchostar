...
function tia_scripts() {
	...
	wp_enqueue_script('soundcloud-api', get_bloginfo('template_url').'/scripts/soundcloud.player.api.js', '', '', true);
	wp_enqueue_script('soundcloud-custom-player', get_bloginfo('template_url').'/scripts/sc-player.js', array('soundcloud-api'), '1.1', true);
